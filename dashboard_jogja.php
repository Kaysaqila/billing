...
// Batasi akses: hanya untuk wilayah Jogja (default). User wilayah lain diarahkan ke dashboard masing-masing
if (isset($_SESSION['wilayah']) && $_SESSION['wilayah'] !== 'jogja') {
...
<head>
    ...
    .modern-table th:nth-child(9) { width: 30%; min-width: 380px; text-align: center; } /* Aksi, lebar minimum diperbesar */
...
<body>
    ...
    <div class="header">
        <h1><i class="fas fa-file-invoice-dollar"></i> Dashboard Billing Jogja</h1>
