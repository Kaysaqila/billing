...
<head>
    ...
    .table-section {
        ...
        .btn-tagihan { 
            background: linear-gradient(90deg, #27ae60, #18a058);
            color: white; 
        }
        
        .btn-tagihan:hover { 
            background: linear-gradient(90deg, #219653, #16a085);
        }
        ...
        @media (max-width: 768px) {
            ...
            /* Action buttons stay aligned on mobile */
            .action-group { 
                flex-direction: row; 
                gap: 6px; 
                flex-wrap: nowrap; 
...
<body>
    ...
    <div class="container">
        <div class="welcome-section">
            ...
            <p>Kelola tagihan dan resi pelanggan</p>
        </div>
    ...
    <script>
        ...
        function loadData(page, search = '') {
            ...
            // Update current search if provided
            if (search !== undefined) {
                currentSearch = search;
            }
            
            // Build URL with search parameter
            let url = `get_data.php?page=${page}&limit=${itemsPerPage}`;
            if (currentSearch) {
                ...
                .catch(err => {
                    ...
                    document.getElementById('table-container').innerHTML = `
                        <div style="padding: 40px; text-align: center; color: var(--danger);">
                            ...
                            <button onclick="loadData(${page}, currentSearch)" class="action-btn btn-edit">
